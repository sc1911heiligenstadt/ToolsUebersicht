...
| **[Digitaler Stempel](https://sc1911heiligenstadt.github.io/digitaler-stempel/)** | PDF- und Word-Dokumente digital stempeln (Position, Größe, Drehung und Deckkraft frei wählbar) — jede Stempelung wird mit Nutzer und Zeitpunkt archiviert (nur für berechtigte Gruppe). | [`digitaler-stempel`](https://github.com/sc1911heiligenstadt/digitaler-stempel) |
