...
// Was die Uebersicht kann -- die Karte "Funktionen" im Info-Reiter. Nutzt
...
// Der einmalige Umschreib-Lauf ueber die Daten aller Werkzeuge stand bis
// 2026-08-12 hier (umschreibLauf/setupUmschreibPanel). Er hat seine Arbeit
// getan -- der Lauf meldete 0 Treffer in 0 Werkzeugen -- und ist auf
// Michel-Entscheidung wieder ausgebaut: ein Knopf, der echte Vereinsdaten
// ueberschreibt, soll nicht dauerhaft herumstehen.
//
// Die Worker-Aktion mannschaften-umschreiben BLEIBT bestehen (admin-only).
// Taucht doch noch irgendwo eine alte Schreibweise auf, ist sie ueber die
// Browser-Konsole erreichbar, ohne dass dafuer ein Worker-Deploy noetig wird:
//   callWorker("mannschaften-umschreiben", { modus: "vorschau", nurListe: true })
// liefert die App-Liste, danach je hoechstens vier Apps mit { modus, apps }.
// ⚠️ Beim Schreiben NIE dieselbe App zweimal in einem Durchgang -- der zweite
// Lauf ueberschriebe ihre Sicherung mit dem bereits geaenderten Stand.
